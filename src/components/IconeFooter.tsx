 ...
 *
 * 🔴 LA MISURA NON E' UNA SCELTA ESTETICA (corretta il 01/09/2026).
 * Il `viewBox` di Font Awesome e' 576x512, cioe' un rapporto di 1,125.
 * La prima versione le disegnava 30x21, che di rapporto fa 1,43: il
 * browser rimpicciolisce il disegno finche' ci sta in altezza e lo
 * centra, quindi si perdevano sette pixel di altezza e restava spazio
 * vuoto ai lati. Sulle altre quattro non si notava; su American
 * Express, che ha la scritta DENTRO la carta invece di un simbolo
 * pieno, a 21 pixel le lettere diventavano una macchia -- segnalato.
 * Ora 38x34, rapporto 1,118: il disegno riempie la casella e la scritta
 * si legge. Se un domani si cambia la larghezza, l'altezza va cambiata
 * con lei: larghezza / 1,125.
 *
...
export const CartaStripe = () => (
  <svg width="38" height="34" viewBox="0 0 576 512" fill="currentColor" role="img" aria-label="Stripe">
...
export const CartaMastercard = () => (
  <svg width="38" height="34" viewBox="0 0 576 512" fill="currentColor" role="img" aria-label="Mastercard">
...
export const CartaVisa = () => (
  <svg width="38" height="34" viewBox="0 0 576 512" fill="currentColor" role="img" aria-label="Visa">
...
export const CartaPayPal = () => (
  <svg width="38" height="34" viewBox="0 0 576 512" fill="currentColor" role="img" aria-label="PayPal">
...
export const CartaAmex = () => (
  <svg width="38" height="34" viewBox="0 0 576 512" fill="currentColor" role="img" aria-label="American Express">
